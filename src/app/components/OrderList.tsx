...
const EmptyState = () => (
  <div className="mt-8 flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 p-8 text-center dark:border-gray-700">
    <PackageX className="h-12 w-12 text-gray-400 dark:text-gray-500" />
